...
const ITEM_CONFIGS = {
  tape: {
    ...
    redirectTo: "/app/vendor/coordinator/view",
...
router.post("/vendor-item/edit/:kind/:id", requireAuth, updateLimiter, async (req, res) => {
  try {
    ...
    res.json({ success: true, redirect: returnTo || `/app/vendor-item/view/${kind}?userId=${binding.vendorUserId}` });
  } catch (err) {
...
router.get("/vendor-item/compare/:kind/:id", async (req, res) => {
  try {
    ...
    res.render("inventory/itemCompare.ejs", {
      ...
      editBindingUrl: `/app/vendor-item/edit/${kind}/${binding._id}`,
...
router.post("/vendor-item/delete/:kind/:id", requireAuth, deleteLimiter, async (req, res) => {
  try {
    ...
    res.redirect(`/app/vendor-item/view/${kind}?userId=${binding.vendorUserId}`);
  } catch (err) {
